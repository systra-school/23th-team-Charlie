...
<body class="anime">
  <!-- 背景動画 -->
    <video id="video-background" autoplay muted loop>
      <source src="/kikin-for-Struts-bug/pages/videos/画面録画 2024-09-13 110219.mp4">
    </video>
 <audio id="bgm" autoplay loop>
    <source src="/kikin-for-Struts-bug/pages/audio/Warning-Siren05-02(Fast-Long).mp3" type="audio/mp3">
    <!-- If the file type is different, specify the correct type here -->
  
  </audio>
 
  <div class="content-wrapper">
    <a href="/kikin-for-Struts-bug/pages/cmn/kaiji1.jsp" class="link-text">管理者に連絡</a>
  </div>
  <br>
</body>
</html>
