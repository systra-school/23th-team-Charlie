 ...
 *
 */
public class WorkAttendanceRegisterAction extends Action {
...
//        workRecordLogic.calculation(workRecordDtoList);
        ...
        // 勤務実績データの更新・登録を行う
        workRecordLogic.registerStartWork(loginUserDto);
...
//        workRecordForm.setYearMonthCmbMap(yearMonthCmbMap);
        ...
        String emp_str = "出勤時間を登録済み";
        session.setAttribute("emp_str", emp_str);
